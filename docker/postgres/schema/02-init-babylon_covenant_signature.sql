...
CREATE INDEX IF NOT EXISTS babylon_covenant_signature_02 ON public.babylon_covenant_signature (covenant_btc_pk_id, height);
CREATE INDEX IF NOT EXISTS babylon_covenant_signature_03 ON public.babylon_covenant_signature USING btree (chain_info_id, covenant_btc_pk_id, height asc);