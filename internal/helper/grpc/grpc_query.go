...
func GrpcInvokeQuery(
	...
	fullMethodName := "/" + string(methodDescriptor.Parent().FullName()) + "/" + string(methodDescriptor.Name())
	var headerMD metadata.MD
	err = conn.Invoke(ctx, fullMethodName, msgRaw, response, grpc.Header(&headerMD))
	if err != nil {
